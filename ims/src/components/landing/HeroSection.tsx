...
export const HeroSection: React.FC<HeroSectionProps> = ({ reduceMotion }) => {
  ...
  return (
    <motion.div 
      className="relative overflow-hidden bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-700 pt-32 pb-20"
      style={{ 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 lg:py-32 relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="text-left">
            ...
            >
              Streamline your hiring process with our comprehensive interview management system that connects candidates, interviewers and administrators.
            </motion.p>
            ...
            >
              ...
              <div>
                ...
                <div className="text-sm opacity-80">Join the leading hiring teams</div>
              </div>
            </motion.div>
          </div>
          ...
          >
            <div className="relative bg-white rounded-lg shadow-2xl overflow-hidden border border-blue-100">
              <div className="bg-blue-50 p-4 flex items-center border-b border-blue-100">
                ...
                <div className="text-sm text-center text-slate-600 flex-1">InterviewPro Dashboard</div>
              </div>
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <Badge className="bg-blue-100 text-blue-700 hover:bg-blue-200">3 Today</Badge>
                </div>
                
                <div className="space-y-4">
                  {[
                    { name: "Alex Johnson", role: "Frontend Developer", time: "10:00 AM", status: "Confirmed" },
                    { name: "Sarah Williams", role: "UX Designer", time: "1:30 PM", status: "Pending" },
                    { name: "Michael Chen", role: "Product Manager", time: "4:00 PM", status: "Confirmed" }
                  ].map((interview, idx) => (
                    <motion.div
                      key={idx}
                      ...
                      whileHover={{ scale: 1.02, boxShadow: "0 4px 6px -1px rgba(0, 0, 0, 0.05)" }}
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        <Badge className={interview.status === "Confirmed" 
            ...
            >
              ...
              <div className="text-xs text-gray-500">
                James Peterson has completed the technical assessment with a score of 92%
              </div>
            </motion.div>
            ...
            >
              <div className="text-white text-sm font-medium mb-2">Time Saved This Week</div>
              <div className="text-2xl font-bold text-white">12+ Hours</div>
              <div className="text-xs text-blue-200 mt-1">Compared to manual scheduling</div>
            </motion.div>
          </motion.div>
        </div>
      </div>
